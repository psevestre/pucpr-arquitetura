...
import br.pucpr.examples.blog.config.Constants;
import br.pucpr.examples.blog.domain.PersistentToken;
import br.pucpr.examples.blog.domain.User;
import br.pucpr.examples.blog.repository.AuthorityRepository;
import br.pucpr.examples.blog.repository.PersistentTokenRepository;
import br.pucpr.examples.blog.repository.UserRepository;
import br.pucpr.examples.blog.security.AuthoritiesConstants;
import br.pucpr.examples.blog.service.UserService;
import br.pucpr.examples.blog.service.dto.AdminUserDTO;
import br.pucpr.examples.blog.service.dto.PasswordChangeDTO;
import br.pucpr.examples.blog.web.rest.vm.KeyAndPasswordVM;
import br.pucpr.examples.blog.web.rest.vm.ManagedUserVM;
