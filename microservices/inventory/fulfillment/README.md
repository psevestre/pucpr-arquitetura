...
To build the final jar and optimize the fulfillment application for production, run:
...
Then navigate to [http://localhost:8300](http://localhost:8400) in your browser.
