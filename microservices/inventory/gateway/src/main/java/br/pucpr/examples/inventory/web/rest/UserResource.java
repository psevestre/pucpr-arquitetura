package br.pucpr.examples.inventory.web.rest;

import br.pucpr.examples.inventory.config.Constants;
import br.pucpr.examples.inventory.domain.User;
import br.pucpr.examples.inventory.repository.UserRepository;
import br.pucpr.examples.inventory.security.AuthoritiesConstants;
import br.pucpr.examples.inventory.service.MailService;
import br.pucpr.examples.inventory.service.UserService;
import br.pucpr.examples.inventory.service.dto.AdminUserDTO;
import br.pucpr.examples.inventory.web.rest.errors.BadRequestAlertException;
import br.pucpr.examples.inventory.web.rest.errors.EmailAlreadyUsedException;
import br.pucpr.examples.inventory.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link br.pucpr.examples.inventory.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
