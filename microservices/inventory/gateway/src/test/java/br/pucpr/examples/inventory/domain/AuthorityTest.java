package br.pucpr.examples.inventory.domain;

import static br.pucpr.examples.inventory.domain.AuthorityTestSamples.*;
import static org.assertj.core.api.Assertions.assertThat;

import br.pucpr.examples.inventory.web.rest.TestUtil;
