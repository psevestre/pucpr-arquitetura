package br.pucpr.examples.inventory.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("br.pucpr.examples.inventory.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("br.pucpr.examples.inventory.security.DomainUserDetailsService", "createSpringSecurityUser");
