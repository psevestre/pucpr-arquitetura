...
public class OrderTestSamples {
    ...
    public static Order getOrderSample1() {
        return new Order().id(1L).orderId("orderId1");
    }

    public static Order getOrderSample2() {
        return new Order().id(2L).orderId("orderId2");
    }

    public static Order getOrderRandomSampleGenerator() {
        return new Order().id(longCount.incrementAndGet()).orderId(UUID.randomUUID().toString());
    }
}
