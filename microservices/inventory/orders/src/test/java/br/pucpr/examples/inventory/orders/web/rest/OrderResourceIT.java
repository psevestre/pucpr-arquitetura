...
import static br.pucpr.examples.inventory.orders.domain.OrderAsserts.*;
...
class OrderResourceIT {
    ...
    public static Order createEntity() {
        return new Order().orderId(DEFAULT_ORDER_ID).createdAt(DEFAULT_CREATED_AT).status(DEFAULT_STATUS);
    }
    ...
    public static Order createUpdatedEntity() {
        return new Order().orderId(UPDATED_ORDER_ID).createdAt(UPDATED_CREATED_AT).status(UPDATED_STATUS);
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.orderId(UPDATED_ORDER_ID).createdAt(UPDATED_CREATED_AT).status(UPDATED_STATUS);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.createdAt(UPDATED_CREATED_AT).status(UPDATED_STATUS);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.orderId(UPDATED_ORDER_ID).createdAt(UPDATED_CREATED_AT).status(UPDATED_STATUS);
