...
import { sampleWithRequiredData } from '../order-customer.test-samples';
...
describe('OrderCustomer Management Component', () => {
  let comp: OrderCustomerComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(OrderCustomerComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.orderCustomers()[0]).toEqual(expect.objectContaining({ id: 18682 }));
  });

  describe('trackId', () => {
    it('Should forward to orderCustomerService', () => {
      const entity = { id: 18682 };
      jest.spyOn(service, 'getOrderCustomerIdentifier');
      const id = comp.trackId(entity);
      expect(service.getOrderCustomerIdentifier).toHaveBeenCalledWith(entity);
