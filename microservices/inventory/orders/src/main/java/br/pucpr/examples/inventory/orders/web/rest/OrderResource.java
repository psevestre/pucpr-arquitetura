...
import br.pucpr.examples.inventory.orders.domain.Order;
import br.pucpr.examples.inventory.orders.repository.OrderRepository;
...
/**
 * REST controller for managing {@link br.pucpr.examples.inventory.orders.domain.Order}.
 */
@RestController
...
public class OrderResource {
    ...
    private static final String ENTITY_NAME = "ordersOrder";
